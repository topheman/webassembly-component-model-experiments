...
pub extern "C" fn set_plugins(plugins: Vec<exports::repl::api::repl_logic::PluginConfig>) {
...
#[export_name = "set-env"]
pub extern "C" fn set_env(env_var: exports::repl::api::repl_logic::ReplEnvVar) {
    println!("Setting env var: {} = {}", env_var.key, env_var.value);
}

#[export_name = "list-env"]
pub extern "C" fn list_env() -> Vec<exports::repl::api::repl_logic::ReplEnvVar> {
    Vec::new()
}
